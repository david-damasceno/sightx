    ...
    <div className="w-full">
      <div className="flex justify-between">
        {steps.map((step, index) => (
          ...
          >
            <div className={cn(
              "w-14 h-14 rounded-full flex items-center justify-center transform transition-all duration-200",
              "group-hover:scale-110",
              step.status === 'completed' && "bg-green-100 dark:bg-green-900",
              step.status === 'active' && "bg-primary/20 ring-2 ring-primary ring-offset-2",
            ...
            {index < steps.length - 1 && (
              <div className={cn(
                "absolute top-7 left-[60%] w-[calc(100%-60%)] h-[2px]",
